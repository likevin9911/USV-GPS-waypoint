...
#include "usv_msg/Waypoint.h"
#include "usv_msg/WaypointRoute.h"
...
typedef usv_vrx::GuidanceAlgorithms::Vec2D Vec2D; 
...
class WaypointFollower
{
  ...
  private:
    ...
    std::vector<usv_msg::Waypoint> waypoint_list_;
    ...
    */
    void assignCourse(usv_msg::Course& msg, bool station);
    ...
    * @param msg the received message.
    */
    void waypointCb(const usv_msg::WaypointRoute::ConstPtr& msg);
};
