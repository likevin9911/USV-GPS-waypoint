...
void CourseController::setupThrustController()
{
  ...
  thrust_controller_ = new usv_vrx::ThrustController(thrust_config_,
  ...
  thrust_sm_ = new usv_vrx::ThrustSM(reconfig_duration);
}
...
void CourseController::courseCb(const usv_msg::Course::ConstPtr& msg)
{
